...
buyer_correlated_file = "../data/buyer.correlated.RDS"
...
**So the best approach to target buyers would be to find a target group that satisfies the values of the attributes above and in the Excel file.**
...
Cluster 1 has a majority non-buyers. Cluster 2 has a majority of buyers, although not so much prevailing.
...
* *m1_philosophy_2:Strongly agree* has much more cluster 2 respondents, which are higher probability buyers. This is consistent with previous conclusions.
* *m2_awareness_apps_10:Whoop* has more cluster 2 respondents, which are higher probability buyers. This is consistent with previous conclusions.
* *source_10:Work schedule* has more cluster 2 respondents, which are higher probability buyers. This is consistent with previous conclusions.
* *source_12:Medications* has more cluster 1 respondents, which are lesser probability buyers. This is contrary to the previous conclusion.
* *source_17:None* has more cluster 2 respondents, which are higher probability buyers. This is consistent with previous conclusions.
* *d_child_older:Two* has more cluster 2 respondents, which are higher probability buyers. This is consistent with previous conclusions.
* *d_work_schedule:Rotating work schedule – shift work changes in a repeating pattern* has more cluster 2 respondents, which are higher probability buyers. This is consistent with previous conclusions.
* *d_work_hours:Less than 20* has more cluster 1 respondents, which are lesser probability buyers. This is contrary to the previous conclusion.
...
Clustering *d_work_schedule* indicates that all levels except "Don’t know / not applicable" tend to be cluster 2 which are higher probability buyers.
...
There are some clearly visible values that have more cluster 2 respondents, thus could have a positive influence on the buying odds. But since clustering algorithm was not run as a model for predicting the buyers, we tend to trust the real prediction model that we built before. So we will keep the positive buying predictors from before and add only the levels that have more cluster 2 respondents and that were not negative predictors in the previous model.
...
Looking the these answers, they make sense: the most probable buyers are younger employed parents with children who had some previous experience with the therapy and coaching. This sounds like a group that needs a good sleep-helping app.
